...
class cleanto_adminprofile {
    ...
    public function update_password(){
	 ...
	 public function readone_adminname(){        $query="select * from ".$this->tablename." LIMIT 1";        $result=mysqli_query($this->conn,$query);        $value=mysqli_fetch_row($result);        return $value;    }

	/* Function for add staff */
	public function add_staff(){
		$query="insert into ".$this->tablename." (`id`,`email`,`fullname`,`role`) values(NULL,'".$this->email."','".$this->fullname."','".$this->role."')";
		$result=mysqli_query($this->conn,$query);	
