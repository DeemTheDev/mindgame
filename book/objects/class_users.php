...
return $result;
	...
	public function readone(){
		$query="select * from ".$this->table_name." where id='".$this->user_id."'";$result=mysqli_query($this->conn,$query);
    ...
    public function get_users_totalbookings($userid){
        $query  = "select * from ct_bookings where client_id ='".$userid."' GROUP BY order_id";
        $result=mysqli_query($this->conn,$query);
...
GROUP BY ct_bookings.order_id ORDER BY ct_bookings.order_id";
        $result=mysqli_query($this->conn,$query);
        return $result;
    }
    ...
    {
        $query = "select ct_bookings.*,ct_services.title as sname,ct_payments.payment_method as c_payment_method,ct_payments.net_amount as pna
from ct_bookings,ct_services,ct_payments,ct_services_method
where ct_bookings.client_id='".$this->user_id."'
and ct_bookings.service_id = ct_services.id
and ct_bookings.order_id = ct_payments.order_id
...
GROUP BY ct_bookings.order_id ORDER BY ct_bookings.order_id";
    ...
    public function get_bookings_guests($orderid,$email){
        ...
        $query = "select ct_bookings.*,ct_services.title as sname,ct_payments.payment_method as c_payment_method,ct_payments.net_amount as pna
from ct_order_client_info,ct_bookings,ct_services,ct_payments
where ct_bookings.order_id= '".$orderid."'
and ct_order_client_info.client_email = '".$email."'
and ct_bookings.service_id = ct_services.id
and ct_bookings.order_id = ct_payments.order_id
