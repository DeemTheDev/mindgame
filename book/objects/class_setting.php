...
class cleanto_setting
{
    ...
    */
    public function add_option($option_name, $option_value)
    {
        ...
        $query = "insert into " . $this->table_name . " (`id`,`option_name`,`option_value`) values(NULL,'" . $this->option_name . "','" . $this->option_value . "')";
    ...
    */
    ...
    public function insert_labels_languages($languagearr, $language)
    {
        $query = "insert into " . $this->table_language . " (`id`,`label_data`,`language`) values(NULL,'" . $languagearr . "','" . $language . "')";
        $result = mysqli_query($this->conn, $query);
        return $result;
    }
    public function update_labels_languages($languagearr, $id)
    {
       $query = "update " . $this->table_language . " set label_data = '" . $languagearr . "' where id = '".$id."'";
        $result = mysqli_query($this->conn, $query);
        return $result;
    }
