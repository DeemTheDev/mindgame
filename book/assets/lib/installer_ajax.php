...
?>
	...
	<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
		...
		<?php 
if(((phpversion() >= '5.3') == false) || ((!ini_get('session_auto_start')) == false) || (extension_loaded('mysqli') == false) || (extension_loaded('gd') == false) || ((extension_loaded('curl')) == false) || (is_writable('./../../config.php') == false)){
	?>
...
elseif(isset($_POST['add_admin']) && $_POST['add_admin'] == "1"){
	...
	if($con->connect_error)
	{
		...
		$configure->q26(); $configure->q23(); 
		$insertedadminid = $con->insert_id;
