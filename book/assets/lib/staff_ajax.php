...
else if(isset($_POST['staff_detail']))
{
	...
	<div class="ct-staff-details tab-content col-md-9 col-sm-9 col-lg-9 col-xs-12">
                ...
                <div class="tab-pane col-lg-12 col-md-12 col-sm-12 col-xs-12 active" id="member-details">
				 ...
				 <div class="tab-pane member-service-details" id="member-service-details">
                    <div class="panel panel-default">
						<table id="ct-staff-service-details-list" class="table table-bordered table-striped" cellspacing="0" width="100%">
							<thead>
