...
if(isset($_POST['action']) && $_POST['action']=='complete_booking'){
	...
	if($_POST['payment_method'] == 'payumoney2'){
		header('location:'.FRONT_URL.'payumoney_payment_process.php?deposit=500');
		exit(0);
	}	
