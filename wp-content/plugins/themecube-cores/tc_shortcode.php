...
function shortcode_tc_rooms_carousel($atts, $content=null){
    ...
    <div class="col-lg-12">
        ...
        if($project->have_posts()):
            ...
            if ($title != "The Great Time Escape" || $title != "Escape to Treasure Island"):
                $age_reco = "<p>Recommended for ages 13 and up.</p>";
                $blurb = "<p>Challenging rooms. Great for teambuilding packages.</p>";
                $location = "<p>NB! LOCATED in Granada Square, 16 Chartwell Dr.</p>";
            endif;

            if ($title == "The Great Time Escape" || $title == "Escape to Treasure Island"):
                $age_reco = "<p>Recommended for ages 7 and up.</p>";
                $blurb = "<p>Perfect for birthdays and teambuilding events, VR games and laser tag are available at discounted prices. Note that the rooms at this location are not as challenging as those at our Granada branch.</p>";
                $location = "<p>NB! LOCATED in PAVILLION MALL Westville</p>";
            endif;
