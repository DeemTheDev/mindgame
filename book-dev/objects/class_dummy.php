...
class dummy{
	...
	public function add_services_method(){
		$query="insert into ".$this->services_method." (`id`,`service_id`,`method_title`,`status`) values(NULL,'".$this->sm_service_id."','".$this->sm_method_title."','".$this->sm_status."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_services_method_unit(){
		$query="insert into ".$this->service_methods_units." (`id`,`services_id`,`methods_id`,`units_title`,`base_price`,`maxlimit`,`status`) values(NULL,'".$this->smu_service_id."','".$this->smu_methods_id."','".$this->smu_units_title."','".$this->smu_base_price."','".$this->smu_maxlimit."','".$this->smu_status."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_week_days_available(){
		$query="insert into ".$this->week_days_available." (`id`,`provider_id`,`week_id`,`weekday_id`,`day_start_time`,`day_end_time`,`off_day`) values(NULL,'','".$this->wda_week_id."','".$this->wda_weekday_id."','".$this->wda_day_start_time."','".$this->wda_day_end_time."','".$this->wda_off_days."')";
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_off_days(){
		$query="insert into ".$this->off_days." (`id`,`user_id`,`off_date`,`lastmodify`,`status`) values(NULL,'"."','".$this->od_off_date."','"."','"."')";
		$result=mysqli_query($this->conn,$query);		
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_payments(){
		$query="insert into ".$this->payments." (`id`,`order_id`,`payment_method`,`transaction_id`,`amount`,`discount`,`taxes`,`partial_amount`,`payment_date`,`net_amount`,`lastmodify`,`frequently_discount`,`frequently_discount_amount`) values(NULL,'".$this->p_order_id."','".$this->p_payment_method."','".$this->p_transaction_id."','".$this->p_amount."','".$this->p_discount."','".$this->p_taxes."','".$this->p_partial_amount."','".$this->p_payment_date."','".$this->p_net_amount."','"."','".$this->p_frequently_discount."','".$this->p_frequently_discount_amount."')"; 
		$result=mysqli_query($this->conn,$query);
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
	...
	public function add_settings(){
	 ...
	 public function get_all_bookings_byserviceid($id){
        $query="select order_id from ".$this->bookings." where service_id = '".$id."' GROUP BY order_id";
        $result=mysqli_query($this->conn,$query);
        return $result;
    }
