...
else
{
	...
	$pdf->Text(30,60,utf8_decode($label_language_values['invoice']));
	...
	//$pdf->Text(155-$pdf->GetStringWidth(utf8_decode($label_language_values['tax'])),$addondetails_sttpoint+20,utf8_decode($label_language_values['tax']));
	...
	$pdf->SetFont('Arial','',13);
	$pdf->SetTextColor(255,255,255);
	$pdf->Text(140-$pdf->GetStringWidth(utf8_decode($label_language_values['total'])),265,utf8_decode($label_language_values['total']));
	$pdf->Text(168-$pdf->GetStringWidth($printtaxes),265,$printnetamount);
