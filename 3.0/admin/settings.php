...
if(isset($_POST['btn_submit_labels']))
{
	...
	$setting->insert_labels_languages($language_front_arr, $language_admin_arr, $language_error_arr, $language_extra_arr, $language_front_error_arr, $update_labels);	
	header('Location: '.SITE_URL."admin/settings.php");
	exit;
} */
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<input type="text" class="form-control" id="ct_google_analytics_code" name="ct_google_analytics_code" value="<?php echo $setting->get_option('ct_google_analytics_code');?>" placeholder="e.g. XX-XXXXXXXXX-X" />
													</div>
												</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<input type="text" class="form-control" id="ct_page_meta_tag" name="ct_page_meta_tag" value="<?php echo $setting->get_option('ct_page_title');?>" placeholder="<?php echo $label_language_values['Page_Meta_Tag'];?>" />
													</div>
												</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<textarea cols="40" class="form-control" id="ct_seo_meta_description" name="ct_seo_meta_description" placeholder="<?php echo $label_language_values['Meta_Description'];?>"><?php echo $setting->get_option('ct_seo_meta_description');?></textarea>
													</div>
												</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<input type="text" class="form-control" id="ct_seo_og_title" name="ct_seo_og_title" value="<?php echo $setting->get_option('ct_seo_og_title');?>" placeholder="<?php echo $label_language_values['og_tag_title'];?>" />
													</div>
												</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<input type="text" class="form-control" id="ct_seo_og_type" name="ct_seo_og_type" value="<?php echo $setting->get_option('ct_seo_og_type');?>" placeholder="<?php echo $label_language_values['og_tag_type'];?>" />
													</div>
												</div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<div class="cta-col6 ct-w-50">
														<input type="text" class="form-control" id="ct_seo_og_url" name="ct_seo_og_url" value="<?php echo $setting->get_option('ct_seo_og_url');?>" placeholder="<?php echo $label_language_values['og_tag_url'];?>" />
													</div>
												</div>
