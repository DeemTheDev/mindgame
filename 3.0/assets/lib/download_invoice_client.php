...
else
{
	...
	$pdf->Text(25,10,utf8_decode($business_name));
	$pdf->Text(25,15,utf8_decode($business_address));
	$pdf->Text(25,20,utf8_decode($business_city).",".utf8_decode($business_state));
	$pdf->Text(25,25,utf8_decode($business_country));
	$pdf->Text(25,30,utf8_decode($business_email));
	...
	$pdf->Text(155-$pdf->GetStringWidth(utf8_decode($label_language_values['coupon_discount'])),$addondetails_sttpoint+15,utf8_decode($label_language_values['coupon_discount']));
	...
	$pdf->SetFont('Arial','',13);
	$pdf->SetTextColor(255,255,255);
	$pdf->Text(150-$pdf->GetStringWidth(utf8_decode($label_language_values['total'])),265,utf8_decode($label_language_values['total']));
